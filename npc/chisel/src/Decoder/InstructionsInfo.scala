...
abstract trait InstructionsInfo {
  ...
  //      srcType(0)      srcType(1)      srcType(2)      fuType          fuOpType  rfWen  ImmFormat
  //        |               |               |               |               |        |      |
     List(SrcType.unknow, SrcType.unknow, SrcType.unknow, FuType.alu, ALUOpType.addi, N, ImmFormat.INVALID)
